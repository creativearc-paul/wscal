<div id="sideBar">
    <div id="activeUser">
        <a class="userName" href="<?=BASE.AMP.'C=myaccount'?>" title="<?=lang('myaccount')?>"><?=$cp_screen_name?> - edit</a>
    ...
    <div<?=$sidebar_state?> id="sidebarContent">
        ...
        <div id="search">
            ...
            <input type="image" src="<?=$cp_theme_url?>images/search_button.png" class="searchButton" />
