...
$config['install_lock'] = "";
$config['license_number'] = "1043-2617-2663-7075";
$config['debug'] = "1";
$config['cp_url'] = "http://wscal.edu/system/index.php";
$config['doc_url'] = "http://ellislab.com/expressionengine/user-guide/";
$config['is_system_on'] = "y";
$config['site_label'] = "Westminster Seminary California";
$config['cookie_prefix'] = "";

$config['autosave_interval_seconds'] = "0";
$config['allow_extensions'] = "y";
$config['enable_db_caching'] = "n";
$config['emoticon_url'] = "http://wscal.edu/assets/smileys/";
...
$config['license_contact'] = 'support@creativearc.com';
...
$config['smtp_username'] = 'weborders@wscal.edu';
$config['smtp_password'] = 'Wscal1725#!';

// END EE config items


$config['assets_cache_remote_images'] = 'no';

////////////////////////////////////
// MULTI SERVER
////////////////////////////////////
//$config['webmaster_email'] = 'greg@creativearc.com';
$config['autosave_interval_seconds'] = "0";
...
$config['tmpl_file_basepath'] = "/var/www/vhosts/wscal.edu/templates";
...
|
*/
$config['base_url']	= "http://wscal.edu/";
...
|
*/
$config['encryption_key'] = "1F80369B43A7FBD20EF4C96A75B5401521918966F7C3972344070C52F07F8DC1";
