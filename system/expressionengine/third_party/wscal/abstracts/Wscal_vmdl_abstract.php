...
class Wscal_vmdl_abstract extends CI_Model {
    ...
    * ...
    * 'child_dob'           => 'exp_ctdm_child.child_dob',
    * 'child_dob_display'   => 'DATE_FORMAT(exp_ctdm_child.child_dob, "%c-%e-%Y")',
    * 'child_last_name'     => 'exp_ctdm_child.child_last_name',
    * 'child_full_name'     => 'CONCAT(exp_ctdm_child.child_last_name, ", ", exp_ctdm_child.child_first_name, " ", exp_ctdm_child.child_middle)',
    * ...
    * @var array
    */
    ...
    * 'exp_ctdm_family' => 'exp_ctdm_child.family_id = exp_ctdm_family.family_id'
    * @var array
    */
    public $_join = array();
    ...
    * 'child_dob' => array( 
    *                     'column' => 'exp_ctdm_child.child_dob',
    *                     'format' => 'mysql_date'
    *                      ),                      
    * @var array
    */
    ...
    * $_always_where_in = array(
    *                       'group_id' => array(1,5,7)
    *                       );
    * @var array
    */
