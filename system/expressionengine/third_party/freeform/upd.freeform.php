...
class Freeform_upd extends Module_builder_freeform
{
	...
	public function update()
	{
		...
		*/
		...
		if (version_compare($this->database_version(), '4.0.0.d1', '<'))
		{
		...
		if (version_compare($this->database_version(), '4.0.0.d5', '<'))
		{
		...
		if (version_compare($this->database_version(), '4.0.0.b2', '<') AND
		...
		if (version_compare($this->database_version(), '4.0.0.b3', '<'))
		{
